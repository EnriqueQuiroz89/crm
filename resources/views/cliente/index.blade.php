                        ...
                        <tbody>
                            ...
                            <tr class="">
                                ...
                                <td class="d-flex justify-content-around">
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editar_{{ $cliente->id }}">
                                        Editar
                                    </button>
                                 

                                     <a href="{{ route('actividad.create', ['cliente' => $cliente->id]) }}" class="btn btn-success">Agregar actividad</a>
